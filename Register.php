...
<!--                                                    <label class="block">
                                                    ...
                                                    <div class="clearfix">
                                                        ...
                                                        <button type="button" class="width-65 pull-right btn btn-sm btn-success" onclick="validate();">
        ...
        <script type="text/javascript">
            ...
            function validate()
            {
               ...
               var http = new XMLHttpRequest();
                                        ...
                                        var params = "function=register_user&&user_id=123&name=" + name +  "&email=" + email + "&password=" + password +"&mobile= "+ mobile;
