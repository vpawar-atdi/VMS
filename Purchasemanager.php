...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Kamala Mills- Purchase Manager</title>
        <?php $current="PurchaseManager"; ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="tabbable">
                                            <ul class="nav nav-tabs" id="myTab">
                                                ...
                                                <li>
                                                    <a data-toggle="tab" href="#selected-vendor">
                                                         <i class="green ace-icon fa fa-home bigger-120"></i>
                                                        Selected Vendor
                                                    </a>
                                                </li>
                                                ...
                                                <li>
                                                    <a data-toggle="tab" href="#finalised-po">
                                                         <i class="green ace-icon fa fa-home bigger-120"></i>
                                            ...
                                            <div class="tab-content">
                                                                ...
                                                                <table id="dynamic-table-summary" class="table table-striped table-bordered table-hover">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>1</td>
                                                                            <td>
                                                                                <span class="label label-sm label-success">PR-02</span>
                                                                            </td>
                                                                            <td>FY/PR/YYMM-01</td>
                                                                                ...
                                                                                <div>
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                <option value="Edit" >Pick Up</option>
                                                                                                <option value="Delete" >Create Inquiry</option>
                                                                                                <option value="Submit" >View Purchase Requisition</option>
                                                                                                <option value="Submit" >Reject Purchase Requisition</option>
                                                                                                </select>
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                ...
                                                                                                <option value="Delete" >View/Edit inquiry</option>
                                                                                                <option value="Submit" >Send inquiry</option>
                                                                                                <option value="Submit" >Drop/Delete</option>
                                                                                                <option value="Submit" >Extend date</option>
                                                                                                </select>
                                                                                            <span class="input-group-addon" style="color:#ffffff;background-color: #D15B47;"><i class="fa fa-caret-right"></i></span>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <div id="analysis" class="tab-pane fade">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div class="clearfix">
                                                                <div class="pull-right tableTools-container-analysis"></div>
                                                            </div>
                                                            <div class="table-header">
                                                                Results
                                                            </div>
                                                            <div style="overflow: auto;">
                                                                <table id="dynamic-table-analysis" class="table table-striped table-bordered table-hover">
                                                                     <thead>
                                                                        <tr>
                                                                            <th>Sr.No.</th>
                                                                            <th>Action</th>
                                                                                ...
                                                                                <div>
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                <option value="Edit" >View PR</option>
                                                                                                <option value="Delete" >View Inquiry</option>
                                                                                                <option value="Submit" >Close Inquiry</option>
                                                                                                <option value="Delete" >Add T & C</option>
                                                                                                <option value="Submit" >Analysis</option>
                                                                                                </select>
                                                                                            <span class="input-group-addon" style="color:#ffffff;background-color: #D15B47;"><i class="fa fa-caret-right"></i></span>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <div id="selected-vendor" class="tab-pane fade">
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div class="clearfix">
                                                                <div class="pull-right tableTools-container-selected-vendor"></div>
                                                            </div>
                                                            <div class="table-header">
                                                                Results
                                                            </div>
                                                            <div style="overflow: auto;">
                                                                <table id="dynamic-table-selected-vendor" class="table table-striped table-bordered table-hover">
                                                                     <thead>
                                                                        <tr>
                                                                            <th>Sr.No.</th>
                                                                            <th>Action</th>
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                ...
                                                                                                <option value="Delete" >View/edit PO</option>
                                                                                                 <option value="Delete" >Add T & C</option>
                                                                                                <option value="Submit" >Send PO for Management</option>
                                                                                                </select>
                                                                                            <span class="input-group-addon" style="color:#ffffff;background-color: #D15B47;"><i class="fa fa-caret-right"></i></span>
                                                                                        </div>
                                                                                    </div>
                                                ...
                                                <div id="finalised-po" class="tab-pane fade in">
                                                    <div class="row">
                                                        <div class="col-xs-12">
                                                            <div class="clearfix">
                                                                <div class="pull-right tableTools-container-finalised-po"></div>
                                                            </div>
                                                            <div class="table-header">
                                                                Results
                                                            </div>
                                                            <div style="overflow: auto;">
                                                                <table id="dynamic-table-finalised-po" class="table table-striped table-bordered table-hover">
                                                                     <thead>
                                                                        <tr>
                                                                            <th>Sr.No.</th>
                                                                            <th>Action</th>
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                <option value="Edit" >View PR</option>
                                                                                                <option value="Delete" >View Inquiry</option>
                                                                                                <option value="Delete" >View Quote</option>
 ...
 <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                $('th input[type=checkbox], td input[type=checkbox]').prop('checked', false);
                //select/deselect all rows according to table header checkbox
                $('#dynamic-table-analysis > thead > tr > th input[type=checkbox], #dynamic-table_wrapper input[type=checkbox]').eq(0).on('click', function () {
                    var th_checked = this.checked; //checkbox inside "TH" table header

                    $('#dynamic-table-analysis').find('tbody > tr').each(function () {
                        var row = this;
                        if (th_checked)
                            myTable.row(row).select();
                        else
                ...
                //select/deselect a row when the checkbox is checked/unchecked
                $('#dynamic-table-analysis').on('click', 'td input[type=checkbox]', function () {
                    var row = $(this).closest('tr').get(0);
                    if (this.checked)
                        myTable.row(row).deselect();
                    else
                ...
                $(document).on('click', '#dynamic-table-analysis .dropdown-toggle', function (e) {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    e.preventDefault();
                });
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                myTable.buttons().container().appendTo($('.tableTools-container-selected-vendor'));
                //style the message box
                var defaultCopyAction = myTable.button(1).action();
                myTable.button(1).action(function (e, dt, button, config) {
                    defaultCopyAction(e, dt, button, config);
                ...
                myTable.button(0).action(function (e, dt, button, config) {
                    ...
                    $('.dt-button-collection').appendTo('.tableTools-container-selected-vendor .dt-buttons')
                });
                ////

                setTimeout(function () {
                    $($('.tableTools-container-selected-vendor')).find('a.dt-button').each(function () {
                        var div = $(this).find(' > div').first();
                        if (div.length == 1)
                            div.tooltip({container: 'body', title: div.parent().text()});
                        else
                ...
                $('th input[type=checkbox], td input[type=checkbox]').prop('checked', false);
                //select/deselect all rows according to table header checkbox
                $('#dynamic-table-selected-vendor > thead > tr > th input[type=checkbox], #dynamic-table_wrapper input[type=checkbox]').eq(0).on('click', function () {
                    var th_checked = this.checked; //checkbox inside "TH" table header

                    $('#dynamic-table-selected-vendor').find('tbody > tr').each(function () {
                        var row = this;
                        if (th_checked)
                            myTable.row(row).select();
                        else
                ...
                //select/deselect a row when the checkbox is checked/unchecked
                $('#dynamic-table-selected-vendor').on('click', 'td input[type=checkbox]', function () {
                    var row = $(this).closest('tr').get(0);
                    if (this.checked)
                        myTable.row(row).deselect();
                    else
                ...
                $(document).on('click', '#dynamic-table-selected-vendor .dropdown-toggle', function (e) {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    e.preventDefault();
                });
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                myTable.buttons().container().appendTo($('.tableTools-container-finalised-po'));
                //style the message box
                var defaultCopyAction = myTable.button(1).action();
                myTable.button(1).action(function (e, dt, button, config) {
                    defaultCopyAction(e, dt, button, config);
                ...
                myTable.button(0).action(function (e, dt, button, config) {
                    ...
                    $('.dt-button-collection').appendTo('.tableTools-container-finalised-po .dt-buttons')
                });
                ////

                setTimeout(function () {
                    $($('.tableTools-container-finalised-po')).find('a.dt-button').each(function () {
                        var div = $(this).find(' > div').first();
                        if (div.length == 1)
                            div.tooltip({container: 'body', title: div.parent().text()});
                        else
                ...
                $('th input[type=checkbox], td input[type=checkbox]').prop('checked', false);
                //select/deselect all rows according to table header checkbox
                $('#dynamic-table-finalised-po > thead > tr > th input[type=checkbox], #dynamic-table_wrapper input[type=checkbox]').eq(0).on('click', function () {
                    var th_checked = this.checked; //checkbox inside "TH" table header

                    $('#dynamic-table-finalised-po').find('tbody > tr').each(function () {
                        var row = this;
                        if (th_checked)
                            myTable.row(row).select();
                        else
                ...
                //select/deselect a row when the checkbox is checked/unchecked
                $('#dynamic-table-finalised-po').on('click', 'td input[type=checkbox]', function () {
                    var row = $(this).closest('tr').get(0);
                    if (this.checked)
                        myTable.row(row).deselect();
                    else
                ...
                $(document).on('click', '#dynamic-table-finalised-po .dropdown-toggle', function (e) {
                    e.stopImmediatePropagation();
                    e.stopPropagation();
                    e.preventDefault();
                });
