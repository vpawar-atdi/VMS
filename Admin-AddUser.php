                                        ...
                                        <div class="col-xs-12">
                                            <div class="col-xs-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" id="mobile" placeholder="Enter Mobile Number" class="form-control input-mask-phone">
                                                    </div>
                                                </div>
...
<!--                                                        <input type="text" id="form-field-1-1" placeholder="Enter role" class="form-control">-->
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            ...
            function addUser()
            {
                ...
                var http = new XMLHttpRequest();
                                        ...
                                        var params = "function=add_user&name=" + name  + "&email=" + email + "&password=" + password +"&mobile= "+ mobile+"&role="+role;
