...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Kamla Mills- Management Approval</title>
        <?php $current="ManagementApproval"; ?>
    ...
    <body class="no-skin">
                                                                                    ...
                                                                                    <div>
                                                                                        <div class="input-group">
                                                                                            <select>
                                                                                                ...
                                                                                                <option value="Submit" >View analysis</option>
                                                                                                <option value="Submit" >View quote</option>
                                                                                                <option value="Submit" >Approve</option>
                                                                                                <option value="Submit" >Reject</option>
                                                                                            </select>
        ...
        <script type="text/javascript">
            ...
            jQuery(function ($) {
                ...
                myTable.buttons().container().appendTo($('.tableTools-container-analysis'));
                //style the message box
                var defaultCopyAction = myTable.button(1).action();
                myTable.button(1).action(function (e, dt, button, config) {
                    defaultCopyAction(e, dt, button, config);
                ...
                myTable.button(0).action(function (e, dt, button, config) {
                    ...
                    $('.dt-button-collection').appendTo('.tableTools-container-analysis .dt-buttons')
                });
                ////

                setTimeout(function () {
                    $($('.tableTools-container-analysis')).find('a.dt-button').each(function () {
                        var div = $(this).find(' > div').first();
                        if (div.length == 1)
                            div.tooltip({container: 'body', title: div.parent().text()});
                        else
